...
{
    lireConfig("FichierConf.txt", &NB_THREADS_POOL, &TAILLE_FILE_ATTENTE, &PORT_ACHAT); // permet de lire le fichier de configuration "config.txt"
...
void TraitementConnexion(int sService)// voir pdf
{
